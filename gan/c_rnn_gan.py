# This adapted from a paper and a GitHub repository https://github.com/olofmogren/c-rnn-gan
...
class Generator(nn.Module):
    ''' C-RNN-GAN generator
    '''
    def __init__(self, num_feats, hidden_units=256, drop_prob=0.1, use_cuda=False):
